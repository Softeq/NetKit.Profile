namespace Softeq.NetKit.Profile.Web
{
    public static class ConfigurationSettings
    {
        ...
        public static readonly string ApplicationInsightsInstrumentationKey = "ApplicationInsights:InstrumentationKey";
        public static readonly string SerilogMinimumLevel = "Serilog:MinimumLevel";
        public static readonly string SerilogApplicationName = "Serilog:ApplicationName";
        public static readonly string SerilogFileSizeLimitMBytes = "Serilog:FileSizeLimitMBytes";
        public static readonly string SerilogEnableLocalFileSink = "Serilog:EnableLocalFileSink";
    }
}
